...
const Web3ModalProvider = ({ children }) => {
  ...
  const connect = useCallback(async () => {
    ...
    const _provider = globalThis.ethereum.isXDCPay ? globalThis.web3.currentProvider : globalThis.ethereum;

    try{
      await globalThis.ethereum.request({ method: "eth_requestAccounts" });
    } catch (e) {
      console.log("eth_requestAccounts is not a XDCPay feature!");
    }
